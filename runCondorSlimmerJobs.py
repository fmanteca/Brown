...
relbase = '/uscms/homes/f/fernanpe/work/CMSSW_8_0_26_patch1/'
inputDir='/eos/uscms/store/user/lpcljm/LJMet80x_2lepTT_Full2016_2017_3_3_abarker/'+shift+'/'
outputDir='/eos/uscms/store/user/fernanpe/slimmedTrees/'+shift+'/'
condorDir='/uscms/homes/f/fernanpe/work/CMSSW_8_0_26_patch1/src/output_trees/'+shift+'/'
...
Transfer_Input_Files = %(RUNDIR)s/makeStep1.C, %(RUNDIR)s/%(POST)s/step1_LJMet80x_pedro_Full2016_July2017.cc, %(RUNDIR)s/%(POST)s/step1_LJMet80x_pedro_Full2016_July2017.h, %(RUNDIR)s/%(POST)s/step1_LJMet80x_pedro_Full2016_July2017_cc.d, %(RUNDIR)s/%(POST)s/step1_LJMet80x_pedro_Full2016_July2017_cc.so, %(RUNDIR)s/%(POST)s/fakerate_2lep_ptEta_pedro.h
...
if shift == 'nominal':
    ...
    dirList.append('DoubleEG_PRRBCDEFGH')
    dirList.append('DoubleMuon_PRRBCDEFGH')
    dirList.append('MuonEG_PRRBCDEFGH')
